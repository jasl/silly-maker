...
| `e2e/**` and `template/**` software                                   | The neutral Engine Conformance Story and the starter Story skeleton, explicitly marked MIT in package metadata and SPDX headers                                                       | [MIT](LICENSES/MIT.txt)                                                   |
| `examples/**` software                                                | Example Story logic, rules, values, and integration tests; package metadata and SPDX headers make the specific designation (bookshop is MIT; cat-cafe is PolyForm)                    | [PolyForm Noncommercial 1.0.0](LICENSES/PolyForm-Noncommercial-1.0.0.txt) |
...
| Project-owned narrative, localization, art, audio, and design content | Original expressive game content in `art-source/**` and Story content or asset directories under `examples/**` (for example the cat-cafe narrative, DESIGN.md, and localization text) | [CC BY-NC-SA 4.0](LICENSES/CC-BY-NC-SA-4.0.txt)                           |
