...
import type { AuthoritativeDeterminismCommandClassV1 } from "@sillymaker/base/testkit";
...
export async function collectAuthoritativeDeterminismTraceV1(): Promise<
...
> {
  ...
  for (const commandClass of authoritativeDeterminismCommandClassesV1) {
    const prepared = prepareAuthoritativeDeterminismWorkloadV1({ commandClass });
