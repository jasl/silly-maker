...
| `vn-reference-tour/` | WIP VN Reference Product candidate. M0–M1 deliver its independent package and complete two-route author/headless data; M2 Player/final presentation remains open, so it is not yet playable.                                                                                                                   | MIT               |
