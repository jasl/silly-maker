...
| `vn-reference-tour/` | WIP VN Reference Product candidate. M0–M1 delivered its independent package and complete two-route author/headless data. M2 is in progress: the engine-maintained default VN Player supplies flush-bottom chrome, click-anywhere advance, and Ctrl/Tab/H input, while final Stage media/audio, rollback/end controls, and product evidence remain open. | MIT               |
