...
| `vn-reference-tour/` | WIP VN Reference Product candidate. M0–M2 delivered its independent package, complete two-route author/headless data, engine-maintained default VN Player, final media/audio, Back/Forward, and responsive/accessibility product matrix. M3 is in progress: boot-time autosave resume and return-to-title/Continue continuity are wired and proven; product menu, the remaining Save/recovery matrix, and settings remain open. | MIT               |
