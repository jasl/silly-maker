...
| `cards/`    | Complete PocketJS Cards 0.6.0 Reference Product rebuilt as a responsive, accessible Browser/Deno GUI through the neutral Application Host and public GUI Composition/Code Surface path. Its exact denominator, raw product budgets, Browser/mobile matrix, Desktop packaging preview, final-graph exclusions, independent reviews, and Starter feedback closed on 2026-08-25.                                                                                                                                                                                                                                                      | Code and text MIT; CSS/vector art project-owned |
