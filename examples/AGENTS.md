...
| ---------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `silly-os/`            | GUI-only Creator Preview: Creator Home opens a Program Workspace where the one built-in Agent Creator produces a deterministic initial proposal, preview, and review flow. The opt-in `?agent=pi-test` B0a route lazy-loads the product-pinned Pi Agent into a Browser Worker behind typed RPC and proves one deterministic AgentTool successor; it is not a live LLM/provider. The current slice still has no database, workspace runtime, Mod activation, or persistence; design contract in `silly-os/DESIGN.md`.                                                                                                                                                                                                                         | Code and text MIT |
...
local preview plus the opt-in deterministic Pi wiring check honestly. Agent
Creator is its only built-in user-facing program. Accepting a proposal never
invokes Pi, stores a Program, activates a Mod, or persists anything. Only the
query-gated B0a follow-up crosses its typed Browser Worker RPC; it must not be
presented as a live provider route.
