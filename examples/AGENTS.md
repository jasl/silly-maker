...
| `cat-cafe/` | 旗舰完整游戏：内容数据库、舞台命中区域、回合制、事件池、元进度、i18n、调参通道、运行时美术管线（23 张 AIGC webp，digests 在 `presentation.ts` 声明）、标题屏/结局演出、桌面打包（含图标）；设计规格在 `cat-cafe/DESIGN.md` | 代码与文案 MIT；AIGC 美术与音频 CC0 |
