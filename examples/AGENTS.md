...
journey—Creator Home → Settings when needed → Program Workspace—and label the
deterministic runtime wiring route and Browser compatibility boundary honestly.
Agent Creator is its only built-in user-facing program. Accepting a
proposal never invokes Pi or activates a Mod. The ordinary Provider path and
