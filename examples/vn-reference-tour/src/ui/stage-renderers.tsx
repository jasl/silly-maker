...
function VnBackgroundV1(props: {
  ...
  if (url !== null) {
    return (
      <img
        src={url}
        alt=""
        data-vn-reference-tour-surface={surface}
  ...
  return (
    <div
      data-vn-reference-tour-surface={surface}
      data-vn-reference-tour-media-fallback="true"
      style={{
        width: "1600px",
        height: "900px",
...
function VnCharacterV1(props: {
  ...
  if (url !== null) {
    return (
      <figure
        data-vn-reference-tour-character={props.entry.contentId}
        data-vn-reference-tour-expression={expression}
        data-vn-reference-tour-frame-asset={frameAssetId}
        style={{
          margin: 0,
          width: "100%",
          height: "100%",
...
function VnPropV1(props: {
  ...
  return (
    <figure
      data-vn-reference-tour-prop={kind}
      data-vn-reference-tour-prop-state={state}
      data-vn-reference-tour-prop-asset={assetId}
      {...(url === null ? { "data-vn-reference-tour-media-fallback": "true" } : {})}
      style={{
        margin: 0,
        width: "100%",
        height: "100%",
...
export function createVnReferenceTourStageRenderersV1(
