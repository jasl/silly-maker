...
const openingV1 = [
  { kind: "invoke" as const, actionId: "cc.begin_story" as const },
...
const scenariosV1 = {
  ...
  "first-day": [
    ...openingV1,
    { kind: "activity" as const, activityId: "activity.play" },
    { kind: "pet" as const, zone: "head" },
    { kind: "invoke" as const, actionId: "cc.advance_slot" as const },
    { kind: "activity" as const, activityId: "activity.business" },
    { kind: "invoke" as const, actionId: "cc.advance_slot" as const },
    { kind: "activity" as const, activityId: "activity.nap" },
    { kind: "invoke" as const, actionId: "cc.advance_slot" as const },
    { kind: "invoke" as const, actionId: "cc.advance_slot" as const },
  ],
};
