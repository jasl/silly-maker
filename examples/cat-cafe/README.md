...
代码、文案与设计 MIT；AIGC 生成的美术与合成音频为 CC0 1.0 公共领域贡献（可商用、可演绎、无需署名）。见仓库根 `LICENSE.md`。工程背景：设计规格 [DESIGN.md](DESIGN.md)，引擎缺口分析 [研究笔记](../../docs/research/2026-07-28-imouto-rpgmv-gap-analysis.md)。
