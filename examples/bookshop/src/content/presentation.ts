...
import { bookshopContentIdsV1 } from "../story/narrative.ts";
  ...
  catalogs: [
    {
      ...
      entries: [
        ...
        { textId: "text.bookshop.playback.auto", text: "自动" },
        { textId: "text.bookshop.playback.skip", text: "快进" },
        { textId: "text.bookshop.playback.history", text: "历史" },
        { textId: "text.bookshop.playback.history.title", text: "对话历史" },
        { textId: "text.bookshop.playback.history.empty", text: "还没有对话。" },
        { textId: "text.bookshop.playback.history.close", text: "关闭历史" },
