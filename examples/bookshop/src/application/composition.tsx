...
const bookshopInsufficientCoinsReasonsV1: readonly string[] = [
...
export const bookshopUiProjectorV1 = projectorDefinitionV1;
...
export const bookshopKeyboardMapV1: KeyboardActionMapV1 = {
  Enter: systemInputActionIdsV1.narrativeAdvance,
  Space: systemInputActionIdsV1.narrativeAdvance,
};

export const bookshopRootLabelsV1: Partial<DefaultGameRootLabelsV1> = {
  systemMenuLabel: "系统",
  saveLabel: "保存",
  settingsLabel: "设置",
  settingsTitle: "设置",
...
export const bookshopSaveOverlayLabelsV1: SaveOverlayLabelsV1 = {
  accessibleName: "保存",
  title: "保存",
...
> = {
  ...
  ui: ({ instance }: { readonly instance: BookshopApplicationInstanceV1 }) => ({
    ...
    input: { keyboard: bookshopKeyboardMapV1 },
  }),
};
