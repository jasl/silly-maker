...
> {
  ...
  readonly resetProductWorkspace: () => Promise<ProductWorkspaceResult>;
 ...
 * Product, Credential Vault, Provider-settings, or Workspace authority. A
 * coordination failure is advisory and does not prevent the requested local
 * reset from continuing.
 */
...
>(
  ...
  readonly [
    PromiseSettledResult<ProductWorkspaceResult>,
