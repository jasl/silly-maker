...
import { sillyOsProgramPersistenceFacetsV1 } from "../program-persistence-composition.ts";
...
const runtimeV1 = createProgramDataRepositoryWorkerRuntimeV1({
  repository: createIndexedDbProgramDataRepositoryV1({
    indexedDB: workerScopeV1.indexedDB,
    facets: sillyOsProgramPersistenceFacetsV1,
  }),
