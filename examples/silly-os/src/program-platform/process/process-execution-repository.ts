...
export type ProcessOperationKindV1 =
  | "execution_acquire"
  | "program_facet_execution_acquire"
  | "execution_terminal";
...
export function normalizeProcessOperationReceiptV1(
  ...
  if (
    ...
    ((operation === "execution_acquire" || operation === "program_facet_execution_acquire") !==
      (lease !== null)) ||
    ((operation === "execution_terminal") !== (row.terminalOutcome !== null))
