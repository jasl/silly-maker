...
export type CreatorReadinessRecoveryTargetV1 =
  | "providers"
  | "credential_vault"
  | null;

export type CreatorReadinessV1 =
...
export interface CreatorReadinessInputV1 {
 ...
 */
export function projectCreatorVaultStatusV1(
  vault: ProviderSettingsVaultV1,
): CreatorReadinessInputV1["vaultStatus"] {
  switch (vault.phase) {
    case "unavailable":
...
export function creatorVaultCanHandoffProviderCredentialV1(
  vault: ProviderSettingsVaultV1,
): boolean {
 ...
 */
export function creatorVaultHasProviderCredentialV1(
  vault: ProviderSettingsVaultV1,
...
/**
 * Projects the first actionable blocker in Creator's fixed product dependency
 * order: catalog, vault, enabled model, endpoint credential, then Agent.
 */
export function projectCreatorReadinessV1(
  input: CreatorReadinessInputV1,
): CreatorReadinessV1 {
