...
} from "../../runtime-profile/translation-runtime-profile.ts";
// Deno 2.9 admits text import attributes; TypeScript has no ambient `.md` module declaration.
// @ts-ignore research-only Deno text module
import translationProgramSystemPromptV1 from "../../package/PROGRAM.md" with { type: "text" };
import type { TranslationBatchRequestV1 } from "../../runtime/translation-batch-protocol.ts";
import type { TranslationTargetUnitV1 } from "../../runtime/translation-document-codec.ts";
