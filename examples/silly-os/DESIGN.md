...
| Product/Workspace storage     | Product metadata and preferences remain on the control origin; physical Product Repository V7 retains the V6 Program/continuation pair, discards the superseded grant store, and adds one separate non-secret Program network-access store. Missing rows mean disabled. The exact V6→V7 upgrade does not translate historical grants, so upgraded Programs fail closed; Workspace bytes remain Sandbox-origin OPFS                                                                                                                                                                                                                                                                                                                                                                                                  | Old control-origin OPFS bytes may remain browser-managed but are unreachable and are not migrated; no import/restore or fixed cross-device durability claim exists                                                                                                                                                                                                                                                        |
