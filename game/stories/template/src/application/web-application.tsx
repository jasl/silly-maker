 ...
 * Lab's player (`game/stories/e2e/src/application/narrative-ui.tsx`) shows
 ...
 */
export const templateWebApplicationV1: WebGameApplicationV1<
  unknown,
  unknown,
  TemplateSimulationTypesV1,
  TemplateQueriesV1,
