 ...
 * never enters authoritative arithmetic, resolution legality, hold-arm
 * evaluation, or replay/digest semantics: stage clicks still land on
 * occurrence-fenced commands that reject stale fences wholesale.
