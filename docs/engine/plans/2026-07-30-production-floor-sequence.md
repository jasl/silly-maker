...
**S4b.1a whole-canvas family + routed-input substrate（当前）**；冻结线性顺序为 **S4.3 broad checkpoint（historical） → S4.3.0（docs-only，已完成） → S4.3.1a（已完成；historical） → S4.3.1b（已完成；historical） → S4b broad checkpoint（historical） → S4b.0（docs-only，已完成） → S4b.1a（当前）**。
...
60. S4b.1a：whole-canvas family + routed-input substrate（当前）；
61. S4b.1b：dormant production composition/Host/GameStage substrate（后续）；
...
S4b.1a（当前） → S4b.1b（后续） → S4b.1c（后续） → PF5**；若更早的 family 后续选择 external stable
...
S4.1b.1b.1b.2a → S4.1b.1b.1b.2b → S4.2 → S4.3 broad checkpoint（historical） → S4.3.0（docs-only，已完成） → S4.3.1a（已完成；historical） → S4.3.1b（已完成；historical） → S4b broad checkpoint（historical） → S4b.0（docs-only，已完成） → S4b.1a（当前）。该checkpoint现由下述
...
S4.1b.1b.1b.2b.3 → S4.2 → S4.3 broad checkpoint（historical） → S4.3.0（docs-only，已完成） → S4.3.1a（已完成；historical） → S4.3.1b（已完成；historical） → S4b broad checkpoint（historical） → S4b.0（docs-only，已完成） → S4b.1a（当前）。
...
S4.1b.1b.1b.2b.2 → S4.1b.1b.1b.2b.3 → S4.2 → S4.3 broad checkpoint（historical） → S4.3.0（docs-only，已完成） → S4.3.1a（已完成；historical） → S4.3.1b（已完成；historical） → S4b broad checkpoint（historical） → S4b.0（docs-only，已完成） → S4b.1a（当前）。
...
delivery推进。后续顺序保持S4.1b.1b.1b.2b.2b.1 → S4.1b.1b.1b.2b.3 → S4.2 → S4.3 broad checkpoint（historical） → S4.3.0（docs-only，已完成） → S4.3.1a（已完成；historical） → S4.3.1b（已完成；historical） → S4b broad checkpoint（historical） → S4b.0（docs-only，已完成） → S4b.1a（当前）。
...
S4.1b.1b.1b.2b.3d.1 History exact-parent open intent implementation → S4.2 → S4.3 broad checkpoint（historical） → S4.3.0（docs-only，已完成） → S4.3.1a（已完成；historical） → S4.3.1b（已完成；historical） → S4b broad checkpoint（historical） → S4b.0（docs-only，已完成） → S4b.1a（当前）；
...
S4.3 broad checkpoint（historical） → S4.3.0（docs-only，已完成） → S4.3.1a（已完成；historical） → S4.3.1b（已完成；historical） → S4b broad checkpoint（historical） → S4b.0（docs-only，已完成） → S4b.1a（当前）**。后项只能
...
当前唯一direct RED/implementation gate为 **S4b.1a whole-canvas family + routed-input substrate（当前）**；唯一有效顺序为
...
slice与direct RED/implementation gate现为 **S4b.1a whole-canvas family + routed-input substrate（当前）**；唯一有效顺序为
**S4.3 broad checkpoint（historical） → S4.3.0（docs-only，已完成） → S4.3.1a（已完成；historical） → S4.3.1b（已完成；historical） → S4b broad checkpoint（historical） → S4b.0（docs-only，已完成） → S4b.1a（当前）**。
...
broad implementation checkpoint也已由`.5.1a`–`.5.1c`细分并转为historical，`.5.1a`、`.5.1b`与`.5.1c`现也已由上述delivery关闭。唯一current/next、core
slice与direct RED/implementation gate为 **S4b.1a whole-canvas family + routed-input substrate（当前）**，后续顺序为
**S4.3 broad checkpoint（historical） → S4.3.0（docs-only，已完成） → S4.3.1a（已完成；historical） → S4.3.1b（已完成；historical） → S4b broad checkpoint（historical） → S4b.0（docs-only，已完成） → S4b.1a（当前）**。
...
13. **S4b.1a whole-canvas family + routed-input substrate（当前）**：交付family + routed-input substrate；
14. **S4b.1b dormant production composition/Host/GameStage substrate（后续）**：保持独立merge boundary；
...
**S4b.1a whole-canvas family + routed-input substrate（当前）**，后续唯一顺序为 **S4.3 broad checkpoint（historical） → S4.3.0（docs-only，已完成） → S4.3.1a（已完成；historical） → S4.3.1b（已完成；historical） → S4b broad checkpoint（historical） → S4b.0（docs-only，已完成） → S4b.1a（当前）**。
...
7. **S4b.1a whole-canvas family + routed-input substrate（当前）**：现在进入DOM-free family与routed-input substrate；
8. **S4b.1b dormant production composition/Host/GameStage substrate（后续）**：保持独立merge boundary；
