...
VN Reference Tour 已交付 M0–M1 并进入 M2；引擎维护的 focused default VN Player 已提供贴底对话层、
全画布推进、History/播放控制与 Ctrl/Tab/H 输入，Template 与该产品显式选择同一 preset。完整产品门关闭前，
