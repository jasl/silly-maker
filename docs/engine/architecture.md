...
| `@sillymaker/studio`    | `.`                                                                                                               | The dev-only SillyMaker Studio (VN Scene Workspace): scene navigator, real-renderer canvas, placement inspector, cue list, and the scene CAS IO client. Served exclusively by the dev-server Studio page; player bundles and runtime packages never import it.                         |
