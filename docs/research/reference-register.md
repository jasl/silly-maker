...
## `private-reference:medium-slg-2026-07`

| 字段     | 值                                                                                                                                |
| -------- | --------------------------------------------------------------------------------------------------------------------------------- |
| 类型     | 所有者提供的本地商业游戏参考；对应的未发布验证工作区位于 SillyMaker 仓库之外                                                      |
| 身份     | publication-sensitive；精确作品名、版本、取得路径和工作区路径只随外部私有材料保存，不保留在当前 tracked tree                      |
| 取得日期 | 2026-07-28 登记                                                                                                                   |
| 权利状态 | 未确认；按最严格假设处理                                                                                                          |
| 当前用途 | 只允许归纳中型日程/数值/空间交互 SLG 的通用引擎压力；正式能力由原创 Story 和中性测试独立定义                                      |
| 禁止用途 | 不复制剧情、文本、图像、音频、事件/变量清单、插件、schema、常量或独特结构；不进入生产代码、测试、fixture、生成器、构建或 Artifact |

公开边界记录：`2026-07-28-medium-slg-capability-validation.md`。
