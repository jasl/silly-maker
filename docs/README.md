...
- [Neutral Agent Session/Run and SillyOS handback](engine/plans/2026-08-30-sillyos-neutral-engine-handback.md) — the completed focused promotion of a public transport/provider-neutral Session/Run client and connector; the Agent Host, UiArtifact surface, deterministic fake, and the not-yet-handed-off SillyOS product migration stay separate.
