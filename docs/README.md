...
- [Neutral Agent Session/Run and SillyOS handback](engine/plans/2026-08-30-sillyos-neutral-engine-handback.md) — the completed focused promotion of a public transport/provider-neutral Session/Run client and connector, followed by the completed SillyOS downstream migration; the Agent Host, UiArtifact surface, deterministic fake, and product-owned Worker/Pi/Program semantics stay separate.
- [Agent Session asynchronous connection-loss closure](engine/plans/2026-08-30-agent-session-asynchronous-connection-loss.md) — the owner-activated follow-up that adds a one-shot neutral connection close signal, exact client generation/status fencing and awaited cleanup, then removes SillyOS's transport-private loss bypass without moving product recovery into the Engine.
- [2026-08-30 stage close](engine/plans/2026-08-30-stage-close.md) — post-merge code/document truth cleanup, React Doctor triage, independent review, and final VN/product validation; no successor lane was activated.
...
- [Application Runtime and Embedded Authoring plan](engine/plans/2026-08-18-application-runtime-embedded-authoring.md) — the completed AR0–AR6 engine-first lane for Browser/Deno Desktop startup, private extension-runtime selection, structured operations, the embeddable Authoring Host, and the original private Agent RPC/UiArtifact seam; the later focused Session/Run promotion is tracked above.
...
- [VN Scene Workspace plan](engine/plans/2026-08-14-vn-scene-workspace.md) — historical delivered substrate for first-class Scene documents and authoring geometry; its Studio product shape was later replaced by the Inspector-first shell.
- [Authoring Architecture plan](engine/plans/2026-08-15-authoring-architecture.md) — historical delivered substrate for shared document sessions, project indexing, Story locality, and structured authoring operations; its five-workspace Studio shell is retired.
- [Experimental Composition and State Runtime plan](engine/plans/2026-08-18-experimental-composition-state-runtime.md) — historical strangler evidence and promotion substrate for Composition and the experimental State façade; the later focused public Mod contract is tracked separately.
...
- [Scene authoring and historical SillyMaker Studio](engine/design/scene-authoring-and-studio.md) — the accepted document/geometry substrate and historical Studio product split; current authoring UI boundaries live in the architecture and Story-authoring guides.
...
- [VN genre Mod and authoring plan](engine/plans/2026-08-29-vn-genre-mod-authoring.md) — completed official VN package extraction, optional History selection, and VN-aware Inspector contribution.
- [Production Mod V1 plan](engine/plans/2026-08-29-production-mod-v1.md) — completed focused public trusted build-time Mod contract, external-package smoke, and product-specific declarative override slice.
- [Mod composition and distribution](engine/design/mod-system.md) — focused public Stage A and product-specific declarative Stage B are delivered; discovery/distribution, authoritative R2 adapters, arbitrary-code installation, and sandboxing remain gated.
