...
- [Content vs runtime Snapshot boundary](engine/proposals/external-content-runtime-boundary.md) — where static content ends and mutable gameplay State begins, from the external MV verification.
