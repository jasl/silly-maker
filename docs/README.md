...
- [Production-floor execution sequence](engine/plans/2026-07-30-production-floor-sequence.md) — the only cross-plan ordering entry; PF0–PF7 and the Complexity Reset are complete, PF6 stays evidence-gated, there is currently no active lane (mid-hold input closed 2026-08-22), and desktop durability remains a conditional promotion lane.
- [VN Scene Workspace plan](engine/plans/2026-08-14-vn-scene-workspace.md) — accepted 2026-08-14, completed 2026-08-15: first-class Scene documents compiled into existing runtime contracts, authoring geometry, the project-level Studio shell, direct manipulation, and the scene-first starter migration.
- [Authoring Architecture plan](engine/plans/2026-08-15-authoring-architecture.md) — accepted and completed 2026-08-15: Studio author-trust hardening, the unified authoring shell with workspaces, the project authoring index, shared document sessions, Scene Construction, and the read-only Flow workspace.
